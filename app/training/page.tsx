        ...
        <section className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Master AI technologies and implementation with our comprehensive training programs.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            <div className="bg-gray-800/50 p-6 rounded-lg hover:bg-gray-700/50 transition-colors">
              ...
              <p className="text-gray-400">Learn the basics of AI and machine learning.</p>
            </div>
            
            <div className="bg-gray-800/50 p-6 rounded-lg hover:bg-gray-700/50 transition-colors">
              <Mail className="w-8 h-8 text-blue-400 mb-4" />
              <h3 className="text-xl font-semibold text-white mb-2">Practical Implementation</h3>
              <p className="text-gray-400">Hands-on training with real-world projects.</p>
            </div>
            
            <div className="bg-gray-800/50 p-6 rounded-lg hover:bg-gray-700/50 transition-colors">
              <CheckCircle className="w-8 h-8 text-blue-400 mb-4" />
              <h3 className="text-xl font-semibold text-white mb-2">Advanced Topics</h3>
              <p className="text-gray-400">Deep dive into specialized AI technologies.</p>
            </div>
          </div>
